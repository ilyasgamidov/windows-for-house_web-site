...
var forms = function forms() {
  ...
  var formData = function formData(url, data) {
    var result;
    return regeneratorRuntime.async(function formData$(_context) {
      while (1) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      formData('assets/server.php', formData).then(function (result) {
        console.log(result);
        statusMessage.textContent = messageStatus.success;
      }).catch(function () {
        return statusMessage.textContent = messageStatus.err;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
